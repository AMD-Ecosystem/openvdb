...
//
// HIP-path forwarding header for <cuda.h>: NanoVDB device sources include the CUDA
...
#ifndef NANOVDB_HIP_COMPAT_CUDA_H_INCLUDED
#define NANOVDB_HIP_COMPAT_CUDA_H_INCLUDED
