...
//
// HIP-path forwarding header for <device_launch_parameters.h>: NanoVDB device sources include the CUDA
...
#ifndef NANOVDB_HIP_COMPAT_DEVICE_LAUNCH_PARAMETERS_H_INCLUDED
#define NANOVDB_HIP_COMPAT_DEVICE_LAUNCH_PARAMETERS_H_INCLUDED
