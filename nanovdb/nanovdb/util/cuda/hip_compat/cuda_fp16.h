...
//
// HIP-path forwarding header for <cuda_fp16.h>: NanoVDB device sources include the CUDA
...
#ifndef NANOVDB_HIP_COMPAT_CUDA_FP16_H_INCLUDED
#define NANOVDB_HIP_COMPAT_CUDA_FP16_H_INCLUDED
