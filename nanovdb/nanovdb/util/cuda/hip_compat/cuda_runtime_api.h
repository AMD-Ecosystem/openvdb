...
//
// HIP-path forwarding header for <cuda_runtime_api.h>: NanoVDB device sources include the CUDA
...
#ifndef NANOVDB_HIP_COMPAT_CUDA_RUNTIME_API_H_INCLUDED
#define NANOVDB_HIP_COMPAT_CUDA_RUNTIME_API_H_INCLUDED
